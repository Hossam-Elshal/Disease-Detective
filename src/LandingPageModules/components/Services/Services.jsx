        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#F7FAFC] rounded-lg overflow-hidden shadow-sm max-w-md mx-auto">
            ...
            <div className="p-4 text-center">
              ...
              <Link to='' style={{backgroundColor:'#0367A1'}} className=" text-white text-sm font-medium py-2 px-4 rounded-md">
                Disease Detection
              </Link>
            </div>
          </div>
          ...
          <div className="bg-[#F7FAFC] rounded-lg overflow-hidden shadow-sm max-w-md mx-auto">
            ...
            <div className="p-4 text-left">
              <p className="text-gray-700 text-sm mb-4">
                Select a specific condition and upload related medical records
                for AI-driven analysis and accurate initial assessment.
              </p>
